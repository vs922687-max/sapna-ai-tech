...
export const Route = createFileRoute("/gov/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://bharataisathi.com/gov" },
    ],
    links: [{ rel: "canonical", href: "https://bharataisathi.com/gov" }],
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        url: "https://bharataisathi.com/gov",
        about: GOV_SERVICES.map((s) => ({ "@type": "GovernmentService", name: s.name, url: `https://bharataisathi.com/gov/${s.slug}` })),
      }),
    }],
  }),
  component: GovIndex,
